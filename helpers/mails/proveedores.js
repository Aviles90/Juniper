...
const mailRegistroProveedor = async (email, nombre) => {
...
<head>
  ...
  <title>Confirmación de Cuenta - Restaurante</title>
  ${style}
</head>
<body>
  <div class="container">
      ...
      <div class="content">
          <div class="card">
              <p>Hola ${nombre},</p>
              <p>Estamos muy emocionados de tenerte con nosotros. Tu cuenta ha sido confirmada exitosamente y estamos seguros de que esta colaboración potencializará tus ventas.<br></p>
              <p>Para completar el proceso de verificación de tu cuenta, por favor ingresa al siguiente enlace para completar tu documentación:</p>
              <a href="https://tyva.com.mx/teyeva/public/" class="button">Completar Documentación</a>
              <p>¡Gracias por unirte a nosotros y esperamos tener una colaboración exitosa!</p>
          </div>
      </div>
      <div class="footer">
...
const mailRecuperarCuentaProveedor = async (email, nombre, token) => {
    // send mail with defined transport object
...
<div class="container">
  ...
  <div class="content">
      ...
      <div class="card">
          <p>También puedes copiar la siguiente url en tu navegador:</p>          
          <span>
          https://tyva.com.mx/teyeva/public/?token=${token}
          </span>
      </div>
...
module.exports = {
    mailRegistroProveedor,
    mailRecuperarCuentaProveedor
}